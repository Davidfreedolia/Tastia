  ...
  head: () => ({
    meta: [
      ...
      { title: "Tastia — Catas de vino con amigos, guiadas por un sommelier de IA" },
      {
        name: "description",
        content:
          "Pide tu pack Tastia, escanea el QR y un sommelier de IA con cara y voz guía una cata a ciegas con tus amigos. Sin registros, sin pijería.",
      },
      { property: "og:title", content: "Tastia — Catas de vino con amigos" },
      {
        property: "og:description",
        content: "Un sommelier de IA con cara y voz guía vuestra cata a ciegas. Sin registros.",
      },
