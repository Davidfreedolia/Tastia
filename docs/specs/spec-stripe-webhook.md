...
- **Ruta API** `createAPIFileRoute('/api/stripe-webhook')` (no `createServerFn`: el webhook necesita el cuerpo crudo) -- corre en Vercel con la app, sin Supabase deploy.
